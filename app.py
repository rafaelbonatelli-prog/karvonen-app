...
import io  # <--- Biblioteca nativa adicionada para gerar o arquivo de imagem
...
if arquivos_tcx:
    with st.spinner("Processando o histórico de treinos..."):
        ...
        if historico:
            ...
            # --- GERADOR DE DOWNLOAD DE IMAGEM ---
            buf = io.BytesIO()
            fig.savefig(buf, format="png", dpi=300, bbox_inches='tight') # DPI 300 garante alta qualidade
            buf.seek(0)
